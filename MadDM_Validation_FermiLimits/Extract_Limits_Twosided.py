...
def Extract_Limits_SingleDwarf(Dwarves_List = '' , Masses = '' , Tables =  '' , saveAs='Check'):
  ...
  for D in Dwarves_List:
    ...
    for mDM in Masses: # Filling the lists with the limits for each DM mass
        ...
        bb_lim =      Fermi_sigmav_lim_Twosided(mDM, x = x , dndlogx = bb      , dw_in = dic , marginalize = True)[0]
        tautau_lim =  Fermi_sigmav_lim_Twosided(mDM, x = x , dndlogx = tautau  , dw_in = dic , marginalize = True)[0]
...
def Extract_Limits_Combined(Dwarves_List = '' , Masses = '' , Tables =  '' , Channels = '' , saveAs='Check'):
  ...
  for C in Channels:
    ...
    for mDM in Masses: # Filling the lists with the limits for each DM mass
        ...
        lim = Fermi_sigmav_lim_Twosided(mDM, x = x , dndlogx = y      , dw_in = dic , marginalize = True)[0]
...
Extract_Limits_SingleDwarf(Dwarves_List = Dwarves_List , Masses = Masses , Tables =  Tables , saveAs = 'Limits_Twosided')
Extract_Limits_Combined   (Dwarves_List = Dwarves_List , Masses = Masses , Tables =  Tables , saveAs = 'Limits_Twosided_bb_tautau' , Channels = Channels)
