...
C     *     Decay: w+ > u d~ DMS<=2 WEIGHTED<=2
C     *     Decay: w- > d u~ DMS<=2 WEIGHTED<=2
C     Process: xd xd~ > y0 DMS<=2 WEIGHTED<=2 @1
C     *   Decay: y0 > w+ w- DMS<=2 WEIGHTED<=2
C     *     Decay: w+ > u d~ DMS<=2 WEIGHTED<=2
...
C     *   Decay: y0 > w+ w- DMS<=2 WEIGHTED<=2
C     *     Decay: w+ > u d~ DMS<=2 WEIGHTED<=2
C     *     Decay: w- > s u~ DMS<=2 WEIGHTED<=2
C     Process: xd xd~ > y0 DMS<=2 WEIGHTED<=2 @1
C     *   Decay: y0 > w+ w- DMS<=2 WEIGHTED<=2
C     *     Decay: w+ > u d~ DMS<=2 WEIGHTED<=2
C     *     Decay: w- > s c~ DMS<=2 WEIGHTED<=2
C     Process: xd xd~ > y0 DMS<=2 WEIGHTED<=2 @1
C     *   Decay: y0 > w+ w- DMS<=2 WEIGHTED<=2
C     *     Decay: w+ > u s~ DMS<=2 WEIGHTED<=2
C     *     Decay: w- > d u~ DMS<=2 WEIGHTED<=2
C     Process: xd xd~ > y0 DMS<=2 WEIGHTED<=2 @1
C     *   Decay: y0 > w+ w- DMS<=2 WEIGHTED<=2
C     *     Decay: w+ > u s~ DMS<=2 WEIGHTED<=2
...
C     Process: xd xd~ > y0 DMS<=2 WEIGHTED<=2 @1
C     *   Decay: y0 > w+ w- DMS<=2 WEIGHTED<=2
C     *     Decay: w+ > c d~ DMS<=2 WEIGHTED<=2
C     *     Decay: w- > d u~ DMS<=2 WEIGHTED<=2
C     Process: xd xd~ > y0 DMS<=2 WEIGHTED<=2 @1
C     *   Decay: y0 > w+ w- DMS<=2 WEIGHTED<=2
C     *     Decay: w+ > c d~ DMS<=2 WEIGHTED<=2
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! xd xd~ > u d~ d u~
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! xd xd~ > u d~ d c~
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! xd xd~ > u d~ s u~
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! xd xd~ > u d~ s c~
        IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! xd xd~ > u s~ d u~
        IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! xd xd~ > u s~ d c~
        IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! xd xd~ > u s~ s u~
        IF(IPROC.EQ.8) DSIGPROC=DSIG8(P1,WGT,IMODE)  ! xd xd~ > u s~ s c~
        IF(IPROC.EQ.9) DSIGPROC=DSIG9(P1,WGT,IMODE)  ! xd xd~ > c d~ d u~
        IF(IPROC.EQ.10) DSIGPROC=DSIG10(P1,WGT,IMODE)  ! xd xd~ > c d~ d c~
        IF(IPROC.EQ.11) DSIGPROC=DSIG11(P1,WGT,IMODE)  ! xd xd~ > c d~ s u~
        IF(IPROC.EQ.12) DSIGPROC=DSIG12(P1,WGT,IMODE)  ! xd xd~ > c d~ s c~
        IF(IPROC.EQ.13) DSIGPROC=DSIG13(P1,WGT,IMODE)  ! xd xd~ > c s~ d u~
        IF(IPROC.EQ.14) DSIGPROC=DSIG14(P1,WGT,IMODE)  ! xd xd~ > c s~ d c~
        IF(IPROC.EQ.15) DSIGPROC=DSIG15(P1,WGT,IMODE)  ! xd xd~ > c s~ s u~
        IF(IPROC.EQ.16) DSIGPROC=DSIG16(P1,WGT,IMODE)  ! xd xd~ > c s~ s c~
      ENDIF
