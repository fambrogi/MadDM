...
C     
C     Process: xd xd~ > w- w+ z DMS<=2 WEIGHTED<=6 @2
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     
      ...
      DATA (NHEL(I,  11),I=1,5) / 1,-1, 0,-1, 0/
      DATA (NHEL(I,  12),I=1,5) / 1,-1, 0,-1, 1/
      DATA (NHEL(I,  13),I=1,5) / 1,-1, 0, 0,-1/
      DATA (NHEL(I,  14),I=1,5) / 1,-1, 0, 0, 0/
      DATA (NHEL(I,  15),I=1,5) / 1,-1, 0, 0, 1/
      DATA (NHEL(I,  16),I=1,5) / 1,-1, 0, 1,-1/
      DATA (NHEL(I,  17),I=1,5) / 1,-1, 0, 1, 0/
      ...
      DATA (NHEL(I,  37),I=1,5) / 1, 1, 0,-1,-1/
      DATA (NHEL(I,  38),I=1,5) / 1, 1, 0,-1, 0/
      DATA (NHEL(I,  39),I=1,5) / 1, 1, 0,-1, 1/
      DATA (NHEL(I,  40),I=1,5) / 1, 1, 0, 0,-1/
      DATA (NHEL(I,  41),I=1,5) / 1, 1, 0, 0, 0/
      DATA (NHEL(I,  42),I=1,5) / 1, 1, 0, 0, 1/
      DATA (NHEL(I,  43),I=1,5) / 1, 1, 0, 1,-1/
      DATA (NHEL(I,  44),I=1,5) / 1, 1, 0, 1, 0/
      DATA (NHEL(I,  45),I=1,5) / 1, 1, 0, 1, 1/
      ...
      DATA (NHEL(I,  64),I=1,5) /-1,-1, 0,-1,-1/
      DATA (NHEL(I,  65),I=1,5) /-1,-1, 0,-1, 0/
      DATA (NHEL(I,  66),I=1,5) /-1,-1, 0,-1, 1/
      DATA (NHEL(I,  67),I=1,5) /-1,-1, 0, 0,-1/
      DATA (NHEL(I,  68),I=1,5) /-1,-1, 0, 0, 0/
      DATA (NHEL(I,  69),I=1,5) /-1,-1, 0, 0, 1/
      DATA (NHEL(I,  70),I=1,5) /-1,-1, 0, 1,-1/
      DATA (NHEL(I,  71),I=1,5) /-1,-1, 0, 1, 0/
      DATA (NHEL(I,  72),I=1,5) /-1,-1, 0, 1, 1/
      DATA (NHEL(I,  73),I=1,5) /-1,-1,-1,-1,-1/
      DATA (NHEL(I,  74),I=1,5) /-1,-1,-1,-1, 0/
      DATA (NHEL(I,  75),I=1,5) /-1,-1,-1,-1, 1/
      DATA (NHEL(I,  76),I=1,5) /-1,-1,-1, 0,-1/
      DATA (NHEL(I,  77),I=1,5) /-1,-1,-1, 0, 0/
      DATA (NHEL(I,  78),I=1,5) /-1,-1,-1, 0, 1/
      DATA (NHEL(I,  79),I=1,5) /-1,-1,-1, 1,-1/
      DATA (NHEL(I,  80),I=1,5) /-1,-1,-1, 1, 0/
      DATA (NHEL(I,  81),I=1,5) /-1,-1,-1, 1, 1/
      DATA (NHEL(I,  82),I=1,5) /-1, 1, 1,-1,-1/
      DATA (NHEL(I,  83),I=1,5) /-1, 1, 1,-1, 0/
      DATA (NHEL(I,  84),I=1,5) /-1, 1, 1,-1, 1/
      DATA (NHEL(I,  85),I=1,5) /-1, 1, 1, 0,-1/
      DATA (NHEL(I,  86),I=1,5) /-1, 1, 1, 0, 0/
      DATA (NHEL(I,  87),I=1,5) /-1, 1, 1, 0, 1/
      DATA (NHEL(I,  88),I=1,5) /-1, 1, 1, 1,-1/
      DATA (NHEL(I,  89),I=1,5) /-1, 1, 1, 1, 0/
      DATA (NHEL(I,  90),I=1,5) /-1, 1, 1, 1, 1/
      DATA (NHEL(I,  91),I=1,5) /-1, 1, 0,-1,-1/
      DATA (NHEL(I,  92),I=1,5) /-1, 1, 0,-1, 0/
      DATA (NHEL(I,  93),I=1,5) /-1, 1, 0,-1, 1/
      DATA (NHEL(I,  94),I=1,5) /-1, 1, 0, 0,-1/
      DATA (NHEL(I,  95),I=1,5) /-1, 1, 0, 0, 0/
      DATA (NHEL(I,  96),I=1,5) /-1, 1, 0, 0, 1/
      DATA (NHEL(I,  97),I=1,5) /-1, 1, 0, 1,-1/
      DATA (NHEL(I,  98),I=1,5) /-1, 1, 0, 1, 0/
      DATA (NHEL(I,  99),I=1,5) /-1, 1, 0, 1, 1/
      DATA (NHEL(I, 100),I=1,5) /-1, 1,-1,-1,-1/
      DATA (NHEL(I, 101),I=1,5) /-1, 1,-1,-1, 0/
      DATA (NHEL(I, 102),I=1,5) /-1, 1,-1,-1, 1/
      DATA (NHEL(I, 103),I=1,5) /-1, 1,-1, 0,-1/
      DATA (NHEL(I, 104),I=1,5) /-1, 1,-1, 0, 0/
      DATA (NHEL(I, 105),I=1,5) /-1, 1,-1, 0, 1/
      DATA (NHEL(I, 106),I=1,5) /-1, 1,-1, 1,-1/
      DATA (NHEL(I, 107),I=1,5) /-1, 1,-1, 1, 0/
      DATA (NHEL(I, 108),I=1,5) /-1, 1,-1, 1, 1/
      DATA IDEN/ 4/
...
C     ----------
      ...
      CALL FFS1_2_3(W(1,1),W(1,2),GC_13,GC_14,MDL_MY0,MDL_WY0,W(1,6))
      CALL VVV1P0_1(W(1,3),W(1,4),GC_4,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 1
      CALL VVS1_3_0(W(1,2),W(1,5),W(1,6),GC_73,GC_77,AMP(1))
      CALL VVV1_3(W(1,3),W(1,4),GC_50,MDL_MZ,MDL_WZ,W(1,2))
C     Amplitude(s) for diagram number 2
      CALL VVS1_2_3_0(W(1,2),W(1,5),W(1,6),GC_80,GC_111,GC_82,AMP(2))
      CALL VVV1_2(W(1,3),W(1,5),GC_50,MDL_MW,MDL_WW,W(1,2))
C     Amplitude(s) for diagram number 3
      CALL VVS1_2_3_0(W(1,2),W(1,4),W(1,6),GC_20,GC_102,GC_28,AMP(3))
      CALL VVV1_1(W(1,4),W(1,5),GC_50,MDL_MW,MDL_WW,W(1,2))
C     Amplitude(s) for diagram number 4
      CALL VVS1_2_3_0(W(1,3),W(1,2),W(1,6),GC_20,GC_102,GC_28,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVVS1_2_0(W(1,3),W(1,4),W(1,5),W(1,6),GC_55,GC_62,AMP(5))
