...
C     
C     Process: xd xd~ > w- w+ h z DMS<=2 WEIGHTED<=8 @3
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     
      ...
      DATA (NHEL(I,   2),I=1,6) / 1,-1, 1,-1, 0, 0/
      DATA (NHEL(I,   3),I=1,6) / 1,-1, 1,-1, 0, 1/
      DATA (NHEL(I,   4),I=1,6) / 1,-1, 1, 0, 0,-1/
      DATA (NHEL(I,   5),I=1,6) / 1,-1, 1, 0, 0, 0/
      DATA (NHEL(I,   6),I=1,6) / 1,-1, 1, 0, 0, 1/
      DATA (NHEL(I,   7),I=1,6) / 1,-1, 1, 1, 0,-1/
      DATA (NHEL(I,   8),I=1,6) / 1,-1, 1, 1, 0, 0/
      DATA (NHEL(I,   9),I=1,6) / 1,-1, 1, 1, 0, 1/
      DATA (NHEL(I,  10),I=1,6) / 1,-1, 0,-1, 0,-1/
      DATA (NHEL(I,  11),I=1,6) / 1,-1, 0,-1, 0, 0/
      DATA (NHEL(I,  12),I=1,6) / 1,-1, 0,-1, 0, 1/
      DATA (NHEL(I,  13),I=1,6) / 1,-1, 0, 0, 0,-1/
      DATA (NHEL(I,  14),I=1,6) / 1,-1, 0, 0, 0, 0/
      DATA (NHEL(I,  15),I=1,6) / 1,-1, 0, 0, 0, 1/
      DATA (NHEL(I,  16),I=1,6) / 1,-1, 0, 1, 0,-1/
      DATA (NHEL(I,  17),I=1,6) / 1,-1, 0, 1, 0, 0/
      DATA (NHEL(I,  18),I=1,6) / 1,-1, 0, 1, 0, 1/
      DATA (NHEL(I,  19),I=1,6) / 1,-1,-1,-1, 0,-1/
      DATA (NHEL(I,  20),I=1,6) / 1,-1,-1,-1, 0, 0/
      DATA (NHEL(I,  21),I=1,6) / 1,-1,-1,-1, 0, 1/
      DATA (NHEL(I,  22),I=1,6) / 1,-1,-1, 0, 0,-1/
      DATA (NHEL(I,  23),I=1,6) / 1,-1,-1, 0, 0, 0/
      DATA (NHEL(I,  24),I=1,6) / 1,-1,-1, 0, 0, 1/
      DATA (NHEL(I,  25),I=1,6) / 1,-1,-1, 1, 0,-1/
      DATA (NHEL(I,  26),I=1,6) / 1,-1,-1, 1, 0, 0/
      DATA (NHEL(I,  27),I=1,6) / 1,-1,-1, 1, 0, 1/
      DATA (NHEL(I,  28),I=1,6) / 1, 1, 1,-1, 0,-1/
      DATA (NHEL(I,  29),I=1,6) / 1, 1, 1,-1, 0, 0/
      DATA (NHEL(I,  30),I=1,6) / 1, 1, 1,-1, 0, 1/
      DATA (NHEL(I,  31),I=1,6) / 1, 1, 1, 0, 0,-1/
      DATA (NHEL(I,  32),I=1,6) / 1, 1, 1, 0, 0, 0/
      DATA (NHEL(I,  33),I=1,6) / 1, 1, 1, 0, 0, 1/
      DATA (NHEL(I,  34),I=1,6) / 1, 1, 1, 1, 0,-1/
      DATA (NHEL(I,  35),I=1,6) / 1, 1, 1, 1, 0, 0/
      DATA (NHEL(I,  36),I=1,6) / 1, 1, 1, 1, 0, 1/
      DATA (NHEL(I,  37),I=1,6) / 1, 1, 0,-1, 0,-1/
      DATA (NHEL(I,  38),I=1,6) / 1, 1, 0,-1, 0, 0/
      DATA (NHEL(I,  39),I=1,6) / 1, 1, 0,-1, 0, 1/
      DATA (NHEL(I,  40),I=1,6) / 1, 1, 0, 0, 0,-1/
      DATA (NHEL(I,  41),I=1,6) / 1, 1, 0, 0, 0, 0/
      DATA (NHEL(I,  42),I=1,6) / 1, 1, 0, 0, 0, 1/
      DATA (NHEL(I,  43),I=1,6) / 1, 1, 0, 1, 0,-1/
      DATA (NHEL(I,  44),I=1,6) / 1, 1, 0, 1, 0, 0/
      DATA (NHEL(I,  45),I=1,6) / 1, 1, 0, 1, 0, 1/
      DATA (NHEL(I,  46),I=1,6) / 1, 1,-1,-1, 0,-1/
      DATA (NHEL(I,  47),I=1,6) / 1, 1,-1,-1, 0, 0/
      DATA (NHEL(I,  48),I=1,6) / 1, 1,-1,-1, 0, 1/
      DATA (NHEL(I,  49),I=1,6) / 1, 1,-1, 0, 0,-1/
      DATA (NHEL(I,  50),I=1,6) / 1, 1,-1, 0, 0, 0/
      DATA (NHEL(I,  51),I=1,6) / 1, 1,-1, 0, 0, 1/
      DATA (NHEL(I,  52),I=1,6) / 1, 1,-1, 1, 0,-1/
      DATA (NHEL(I,  53),I=1,6) / 1, 1,-1, 1, 0, 0/
      DATA (NHEL(I,  54),I=1,6) / 1, 1,-1, 1, 0, 1/
      DATA (NHEL(I,  55),I=1,6) /-1,-1, 1,-1, 0,-1/
      DATA (NHEL(I,  56),I=1,6) /-1,-1, 1,-1, 0, 0/
      DATA (NHEL(I,  57),I=1,6) /-1,-1, 1,-1, 0, 1/
      DATA (NHEL(I,  58),I=1,6) /-1,-1, 1, 0, 0,-1/
      DATA (NHEL(I,  59),I=1,6) /-1,-1, 1, 0, 0, 0/
      DATA (NHEL(I,  60),I=1,6) /-1,-1, 1, 0, 0, 1/
      DATA (NHEL(I,  61),I=1,6) /-1,-1, 1, 1, 0,-1/
      DATA (NHEL(I,  62),I=1,6) /-1,-1, 1, 1, 0, 0/
      DATA (NHEL(I,  63),I=1,6) /-1,-1, 1, 1, 0, 1/
      DATA (NHEL(I,  64),I=1,6) /-1,-1, 0,-1, 0,-1/
      DATA (NHEL(I,  65),I=1,6) /-1,-1, 0,-1, 0, 0/
      DATA (NHEL(I,  66),I=1,6) /-1,-1, 0,-1, 0, 1/
      DATA (NHEL(I,  67),I=1,6) /-1,-1, 0, 0, 0,-1/
      DATA (NHEL(I,  68),I=1,6) /-1,-1, 0, 0, 0, 0/
      DATA (NHEL(I,  69),I=1,6) /-1,-1, 0, 0, 0, 1/
      DATA (NHEL(I,  70),I=1,6) /-1,-1, 0, 1, 0,-1/
      DATA (NHEL(I,  71),I=1,6) /-1,-1, 0, 1, 0, 0/
      DATA (NHEL(I,  72),I=1,6) /-1,-1, 0, 1, 0, 1/
      DATA (NHEL(I,  73),I=1,6) /-1,-1,-1,-1, 0,-1/
      DATA (NHEL(I,  74),I=1,6) /-1,-1,-1,-1, 0, 0/
      DATA (NHEL(I,  75),I=1,6) /-1,-1,-1,-1, 0, 1/
      DATA (NHEL(I,  76),I=1,6) /-1,-1,-1, 0, 0,-1/
      DATA (NHEL(I,  77),I=1,6) /-1,-1,-1, 0, 0, 0/
      DATA (NHEL(I,  78),I=1,6) /-1,-1,-1, 0, 0, 1/
      DATA (NHEL(I,  79),I=1,6) /-1,-1,-1, 1, 0,-1/
      DATA (NHEL(I,  80),I=1,6) /-1,-1,-1, 1, 0, 0/
      DATA (NHEL(I,  81),I=1,6) /-1,-1,-1, 1, 0, 1/
      DATA (NHEL(I,  82),I=1,6) /-1, 1, 1,-1, 0,-1/
      DATA (NHEL(I,  83),I=1,6) /-1, 1, 1,-1, 0, 0/
      DATA (NHEL(I,  84),I=1,6) /-1, 1, 1,-1, 0, 1/
      DATA (NHEL(I,  85),I=1,6) /-1, 1, 1, 0, 0,-1/
      DATA (NHEL(I,  86),I=1,6) /-1, 1, 1, 0, 0, 0/
      DATA (NHEL(I,  87),I=1,6) /-1, 1, 1, 0, 0, 1/
      DATA (NHEL(I,  88),I=1,6) /-1, 1, 1, 1, 0,-1/
      DATA (NHEL(I,  89),I=1,6) /-1, 1, 1, 1, 0, 0/
      DATA (NHEL(I,  90),I=1,6) /-1, 1, 1, 1, 0, 1/
      DATA (NHEL(I,  91),I=1,6) /-1, 1, 0,-1, 0,-1/
      DATA (NHEL(I,  92),I=1,6) /-1, 1, 0,-1, 0, 0/
      DATA (NHEL(I,  93),I=1,6) /-1, 1, 0,-1, 0, 1/
      DATA (NHEL(I,  94),I=1,6) /-1, 1, 0, 0, 0,-1/
      DATA (NHEL(I,  95),I=1,6) /-1, 1, 0, 0, 0, 0/
      DATA (NHEL(I,  96),I=1,6) /-1, 1, 0, 0, 0, 1/
      DATA (NHEL(I,  97),I=1,6) /-1, 1, 0, 1, 0,-1/
      DATA (NHEL(I,  98),I=1,6) /-1, 1, 0, 1, 0, 0/
      DATA (NHEL(I,  99),I=1,6) /-1, 1, 0, 1, 0, 1/
      DATA (NHEL(I, 100),I=1,6) /-1, 1,-1,-1, 0,-1/
      DATA (NHEL(I, 101),I=1,6) /-1, 1,-1,-1, 0, 0/
      DATA (NHEL(I, 102),I=1,6) /-1, 1,-1,-1, 0, 1/
      DATA (NHEL(I, 103),I=1,6) /-1, 1,-1, 0, 0,-1/
      DATA (NHEL(I, 104),I=1,6) /-1, 1,-1, 0, 0, 0/
      DATA (NHEL(I, 105),I=1,6) /-1, 1,-1, 0, 0, 1/
      DATA (NHEL(I, 106),I=1,6) /-1, 1,-1, 1, 0,-1/
      DATA (NHEL(I, 107),I=1,6) /-1, 1,-1, 1, 0, 0/
      DATA (NHEL(I, 108),I=1,6) /-1, 1,-1, 1, 0, 1/
      DATA IDEN/ 4/
...
C     ----------
      ...
      CALL FFS1_2_3(W(1,1),W(1,2),GC_13,GC_14,MDL_MY0,MDL_WY0,W(1,7))
      CALL VVV1_3(W(1,3),W(1,4),GC_50,MDL_MZ,MDL_WZ,W(1,2))
C     Amplitude(s) for diagram number 1
      CALL VVSS1_0(W(1,2),W(1,6),W(1,5),W(1,7),GC_110,AMP(1))
      CALL SSS1_2_1(W(1,5),W(1,7),GC_31,GC_22,MDL_MH,MDL_WH,W(1,1))
C     Amplitude(s) for diagram number 2
      CALL VVS2_0(W(1,2),W(1,6),W(1,1),GC_109,AMP(2))
      CALL VVS1_2_3_1(W(1,6),W(1,7),GC_80,GC_111,GC_82,MDL_MZ,MDL_WZ
     $ ,W(1,8))
C     Amplitude(s) for diagram number 3
      CALL VVS2_0(W(1,2),W(1,8),W(1,5),GC_109,AMP(3))
      CALL VVV1P0_1(W(1,3),W(1,4),GC_4,ZERO,ZERO,W(1,9))
      CALL VVS2_1(W(1,6),W(1,5),GC_109,MDL_MZ,MDL_WZ,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL VVS1_3_0(W(1,9),W(1,10),W(1,7),GC_73,GC_77,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVS1_2_3_0(W(1,2),W(1,10),W(1,7),GC_80,GC_111,GC_82,AMP(5))
      CALL VVS2_2(W(1,3),W(1,5),GC_94,MDL_MW,MDL_WW,W(1,2))
C     Amplitude(s) for diagram number 6
      CALL VVVS1_2_0(W(1,2),W(1,4),W(1,6),W(1,7),GC_55,GC_62,AMP(6))
      CALL VVS1_2_3_1(W(1,4),W(1,7),GC_20,GC_102,GC_28,MDL_MW,MDL_WW
     $ ,W(1,9))
C     Amplitude(s) for diagram number 7
      CALL VVV1_0(W(1,2),W(1,9),W(1,6),GC_50,AMP(7))
      CALL VVS1_3P0_1(W(1,6),W(1,7),GC_73,GC_77,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 8
      CALL VVV1_0(W(1,11),W(1,2),W(1,4),GC_4,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL VVV1_0(W(1,2),W(1,4),W(1,8),GC_50,AMP(9))
      CALL VVV1_1(W(1,4),W(1,6),GC_50,MDL_MW,MDL_WW,W(1,12))
C     Amplitude(s) for diagram number 10
      CALL VVS1_2_3_0(W(1,2),W(1,12),W(1,7),GC_20,GC_102,GC_28,AMP(10))
      CALL VVV1_2(W(1,3),W(1,6),GC_50,MDL_MW,MDL_WW,W(1,2))
C     Amplitude(s) for diagram number 11
      CALL VVSS1_0(W(1,2),W(1,4),W(1,5),W(1,7),GC_96,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL VVS2_0(W(1,2),W(1,9),W(1,5),GC_94,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL VVS2_0(W(1,2),W(1,4),W(1,1),GC_94,AMP(13))
      CALL VVS2_1(W(1,4),W(1,5),GC_94,MDL_MW,MDL_WW,W(1,13))
C     Amplitude(s) for diagram number 14
      CALL VVS1_2_3_0(W(1,2),W(1,13),W(1,7),GC_20,GC_102,GC_28,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL VVVS1_2_0(W(1,3),W(1,13),W(1,6),W(1,7),GC_55,GC_62,AMP(15))
      CALL VVS1_2_3_2(W(1,3),W(1,7),GC_20,GC_102,GC_28,MDL_MW,MDL_WW
     $ ,W(1,2))
C     Amplitude(s) for diagram number 16
      CALL VVV1_0(W(1,2),W(1,13),W(1,6),GC_50,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL VVV1_0(W(1,11),W(1,3),W(1,13),GC_4,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL VVV1_0(W(1,3),W(1,13),W(1,8),GC_50,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL VVSS1_0(W(1,3),W(1,12),W(1,5),W(1,7),GC_96,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL VVS2_0(W(1,2),W(1,12),W(1,5),GC_94,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL VVS2_0(W(1,3),W(1,12),W(1,1),GC_94,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL VVVS1_2_0(W(1,3),W(1,4),W(1,10),W(1,7),GC_55,GC_62,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL VVV1_0(W(1,2),W(1,4),W(1,10),GC_50,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL VVV1_0(W(1,3),W(1,9),W(1,10),GC_50,AMP(24))
