...
C     
C     Process: xd xd~ > w- w+ h DMS<=2 WEIGHTED<=6 @2
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     
      ...
      DATA (NHEL(I,   2),I=1,5) / 1,-1, 1, 0, 0/
      DATA (NHEL(I,   3),I=1,5) / 1,-1, 1, 1, 0/
      DATA (NHEL(I,   4),I=1,5) / 1,-1, 0,-1, 0/
      DATA (NHEL(I,   5),I=1,5) / 1,-1, 0, 0, 0/
      DATA (NHEL(I,   6),I=1,5) / 1,-1, 0, 1, 0/
      DATA (NHEL(I,   7),I=1,5) / 1,-1,-1,-1, 0/
      DATA (NHEL(I,   8),I=1,5) / 1,-1,-1, 0, 0/
      DATA (NHEL(I,   9),I=1,5) / 1,-1,-1, 1, 0/
      DATA (NHEL(I,  10),I=1,5) / 1, 1, 1,-1, 0/
      DATA (NHEL(I,  11),I=1,5) / 1, 1, 1, 0, 0/
      DATA (NHEL(I,  12),I=1,5) / 1, 1, 1, 1, 0/
      DATA (NHEL(I,  13),I=1,5) / 1, 1, 0,-1, 0/
      DATA (NHEL(I,  14),I=1,5) / 1, 1, 0, 0, 0/
      DATA (NHEL(I,  15),I=1,5) / 1, 1, 0, 1, 0/
      DATA (NHEL(I,  16),I=1,5) / 1, 1,-1,-1, 0/
      DATA (NHEL(I,  17),I=1,5) / 1, 1,-1, 0, 0/
      DATA (NHEL(I,  18),I=1,5) / 1, 1,-1, 1, 0/
      DATA (NHEL(I,  19),I=1,5) /-1,-1, 1,-1, 0/
      DATA (NHEL(I,  20),I=1,5) /-1,-1, 1, 0, 0/
      DATA (NHEL(I,  21),I=1,5) /-1,-1, 1, 1, 0/
      DATA (NHEL(I,  22),I=1,5) /-1,-1, 0,-1, 0/
      DATA (NHEL(I,  23),I=1,5) /-1,-1, 0, 0, 0/
      DATA (NHEL(I,  24),I=1,5) /-1,-1, 0, 1, 0/
      DATA (NHEL(I,  25),I=1,5) /-1,-1,-1,-1, 0/
      DATA (NHEL(I,  26),I=1,5) /-1,-1,-1, 0, 0/
      DATA (NHEL(I,  27),I=1,5) /-1,-1,-1, 1, 0/
      DATA (NHEL(I,  28),I=1,5) /-1, 1, 1,-1, 0/
      DATA (NHEL(I,  29),I=1,5) /-1, 1, 1, 0, 0/
      DATA (NHEL(I,  30),I=1,5) /-1, 1, 1, 1, 0/
      DATA (NHEL(I,  31),I=1,5) /-1, 1, 0,-1, 0/
      DATA (NHEL(I,  32),I=1,5) /-1, 1, 0, 0, 0/
      DATA (NHEL(I,  33),I=1,5) /-1, 1, 0, 1, 0/
      DATA (NHEL(I,  34),I=1,5) /-1, 1,-1,-1, 0/
      DATA (NHEL(I,  35),I=1,5) /-1, 1,-1, 0, 0/
      DATA (NHEL(I,  36),I=1,5) /-1, 1,-1, 1, 0/
      DATA IDEN/ 4/
...
C     Amplitude(s) for diagram number 1
      CALL SSS1_2_0(W(1,2),W(1,5),W(1,6),GC_31,GC_22,AMP(1))
      CALL VVS2_2(W(1,3),W(1,5),GC_94,MDL_MW,MDL_WW,W(1,2))
C     Amplitude(s) for diagram number 2
      CALL VVS1_2_3_0(W(1,2),W(1,4),W(1,6),GC_20,GC_102,GC_28,AMP(2))
      CALL VVS2_1(W(1,4),W(1,5),GC_94,MDL_MW,MDL_WW,W(1,2))
C     Amplitude(s) for diagram number 3
      CALL VVS1_2_3_0(W(1,3),W(1,2),W(1,6),GC_20,GC_102,GC_28,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL VVSS1_0(W(1,3),W(1,4),W(1,5),W(1,6),GC_96,AMP(4))
