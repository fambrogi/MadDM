...
C     
C     Process: xd xd~ > w- w+ h h DMS<=2 WEIGHTED<=8 @3
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     
      ...
      DATA (NHEL(I,   1),I=1,6) / 1,-1, 1,-1, 0, 0/
      DATA (NHEL(I,   2),I=1,6) / 1,-1, 1, 0, 0, 0/
      DATA (NHEL(I,   3),I=1,6) / 1,-1, 1, 1, 0, 0/
      DATA (NHEL(I,   4),I=1,6) / 1,-1, 0,-1, 0, 0/
      DATA (NHEL(I,   5),I=1,6) / 1,-1, 0, 0, 0, 0/
      DATA (NHEL(I,   6),I=1,6) / 1,-1, 0, 1, 0, 0/
      DATA (NHEL(I,   7),I=1,6) / 1,-1,-1,-1, 0, 0/
      DATA (NHEL(I,   8),I=1,6) / 1,-1,-1, 0, 0, 0/
      DATA (NHEL(I,   9),I=1,6) / 1,-1,-1, 1, 0, 0/
      DATA (NHEL(I,  10),I=1,6) / 1, 1, 1,-1, 0, 0/
      DATA (NHEL(I,  11),I=1,6) / 1, 1, 1, 0, 0, 0/
      DATA (NHEL(I,  12),I=1,6) / 1, 1, 1, 1, 0, 0/
      DATA (NHEL(I,  13),I=1,6) / 1, 1, 0,-1, 0, 0/
      DATA (NHEL(I,  14),I=1,6) / 1, 1, 0, 0, 0, 0/
      DATA (NHEL(I,  15),I=1,6) / 1, 1, 0, 1, 0, 0/
      DATA (NHEL(I,  16),I=1,6) / 1, 1,-1,-1, 0, 0/
      DATA (NHEL(I,  17),I=1,6) / 1, 1,-1, 0, 0, 0/
      DATA (NHEL(I,  18),I=1,6) / 1, 1,-1, 1, 0, 0/
      DATA (NHEL(I,  19),I=1,6) /-1,-1, 1,-1, 0, 0/
      DATA (NHEL(I,  20),I=1,6) /-1,-1, 1, 0, 0, 0/
      DATA (NHEL(I,  21),I=1,6) /-1,-1, 1, 1, 0, 0/
      DATA (NHEL(I,  22),I=1,6) /-1,-1, 0,-1, 0, 0/
      DATA (NHEL(I,  23),I=1,6) /-1,-1, 0, 0, 0, 0/
      DATA (NHEL(I,  24),I=1,6) /-1,-1, 0, 1, 0, 0/
      DATA (NHEL(I,  25),I=1,6) /-1,-1,-1,-1, 0, 0/
      DATA (NHEL(I,  26),I=1,6) /-1,-1,-1, 0, 0, 0/
      DATA (NHEL(I,  27),I=1,6) /-1,-1,-1, 1, 0, 0/
      DATA (NHEL(I,  28),I=1,6) /-1, 1, 1,-1, 0, 0/
      DATA (NHEL(I,  29),I=1,6) /-1, 1, 1, 0, 0, 0/
      DATA (NHEL(I,  30),I=1,6) /-1, 1, 1, 1, 0, 0/
      DATA (NHEL(I,  31),I=1,6) /-1, 1, 0,-1, 0, 0/
      DATA (NHEL(I,  32),I=1,6) /-1, 1, 0, 0, 0, 0/
      DATA (NHEL(I,  33),I=1,6) /-1, 1, 0, 1, 0, 0/
      DATA (NHEL(I,  34),I=1,6) /-1, 1,-1,-1, 0, 0/
      DATA (NHEL(I,  35),I=1,6) /-1, 1,-1, 0, 0, 0/
      DATA (NHEL(I,  36),I=1,6) /-1, 1,-1, 1, 0, 0/
      DATA IDEN/ 8/
...
C     Amplitude(s) for diagram number 1
      CALL SSS1_0(W(1,2),W(1,6),W(1,1),GC_89,AMP(1))
      CALL SSS1_2_1(W(1,6),W(1,7),GC_31,GC_22,MDL_MH,MDL_WH,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL SSS1_0(W(1,2),W(1,5),W(1,8),GC_89,AMP(2))
      CALL SSS1_1(W(1,5),W(1,6),GC_89,MDL_MH,MDL_WH,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL SSS1_2_0(W(1,2),W(1,9),W(1,7),GC_31,GC_22,AMP(3))
      CALL VVS2_2(W(1,3),W(1,5),GC_94,MDL_MW,MDL_WW,W(1,2))
C     Amplitude(s) for diagram number 4
      CALL VVSS1_0(W(1,2),W(1,4),W(1,6),W(1,7),GC_96,AMP(4))
      CALL VVS1_2_3_1(W(1,4),W(1,7),GC_20,GC_102,GC_28,MDL_MW,MDL_WW
     $ ,W(1,10))
C     Amplitude(s) for diagram number 5
      CALL VVS2_0(W(1,2),W(1,10),W(1,6),GC_94,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVS2_0(W(1,2),W(1,4),W(1,8),GC_94,AMP(6))
      CALL VVS2_1(W(1,4),W(1,6),GC_94,MDL_MW,MDL_WW,W(1,11))
C     Amplitude(s) for diagram number 7
      CALL VVS1_2_3_0(W(1,2),W(1,11),W(1,7),GC_20,GC_102,GC_28,AMP(7))
      CALL VVS2_2(W(1,3),W(1,6),GC_94,MDL_MW,MDL_WW,W(1,2))
C     Amplitude(s) for diagram number 8
      CALL VVSS1_0(W(1,2),W(1,4),W(1,5),W(1,7),GC_96,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL VVS2_0(W(1,2),W(1,10),W(1,5),GC_94,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL VVS2_0(W(1,2),W(1,4),W(1,1),GC_94,AMP(10))
      CALL VVS2_1(W(1,4),W(1,5),GC_94,MDL_MW,MDL_WW,W(1,12))
C     Amplitude(s) for diagram number 11
      CALL VVS1_2_3_0(W(1,2),W(1,12),W(1,7),GC_20,GC_102,GC_28,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL VVSS1_0(W(1,3),W(1,12),W(1,6),W(1,7),GC_96,AMP(12))
      CALL VVS1_2_3_2(W(1,3),W(1,7),GC_20,GC_102,GC_28,MDL_MW,MDL_WW
     $ ,W(1,2))
C     Amplitude(s) for diagram number 13
      CALL VVS2_0(W(1,2),W(1,12),W(1,6),GC_94,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL VVS2_0(W(1,3),W(1,12),W(1,8),GC_94,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL VVSS1_0(W(1,3),W(1,11),W(1,5),W(1,7),GC_96,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL VVS2_0(W(1,2),W(1,11),W(1,5),GC_94,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL VVS2_0(W(1,3),W(1,11),W(1,1),GC_94,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL VVSS1_0(W(1,3),W(1,4),W(1,9),W(1,7),GC_96,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL VVS2_0(W(1,2),W(1,4),W(1,9),GC_94,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL VVS2_0(W(1,3),W(1,10),W(1,9),GC_94,AMP(20))
      CALL VVSS1_3(W(1,3),W(1,4),W(1,5),GC_34,MDL_MH,MDL_WH,W(1,10))
C     Amplitude(s) for diagram number 21
      CALL SSS1_2_0(W(1,10),W(1,6),W(1,7),GC_31,GC_22,AMP(21))
      CALL VVSS1_3(W(1,3),W(1,4),W(1,6),GC_34,MDL_MH,MDL_WH,W(1,10))
C     Amplitude(s) for diagram number 22
      CALL SSS1_2_0(W(1,10),W(1,5),W(1,7),GC_31,GC_22,AMP(22))
      CALL VVSS1_2(W(1,3),W(1,5),W(1,6),GC_34,MDL_MW,MDL_WW,W(1,10))
C     Amplitude(s) for diagram number 23
      CALL VVS1_2_3_0(W(1,10),W(1,4),W(1,7),GC_20,GC_102,GC_28,AMP(23))
      CALL VVSS1_1(W(1,4),W(1,5),W(1,6),GC_34,MDL_MW,MDL_WW,W(1,10))
C     Amplitude(s) for diagram number 24
      CALL VVS1_2_3_0(W(1,3),W(1,10),W(1,7),GC_20,GC_102,GC_28,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL VVSSS1_0(W(1,3),W(1,4),W(1,5),W(1,6),W(1,7),GC_37,AMP(25))
