...
def Plot(DM, dic_EW = '', dic_noEW = '', CR = '', channel = '' , scaled = False):
    ...
    tree = r'MadDM $\tilde \chi_1 ^0 \tilde \chi_1 ^0  \rightarrow W^-W^+ $'
    ...
    for C in chans:
        ...
        COLORS = ['blue', 'yellow', 'limegreen', 'cyan', 'orange']
        ...
        LABELS = [ tree , tree + r'$\gamma$' , tree + r'$h$' , tree + r'$z$' , tree + r'$x$' ]
    ...
    g = plt.plot(x, somma, label = r'Sum $(tree+ \gamma +z+h)$', color = 'magenta', ls = '-')	    
    handles.append(g[0])
