...
xsections_dic = { 'z' : { '1': { 'abs':  [96.5 , 12.4 , 0.6 ]  , 'rel': [1 , 12.4/96.5  , 0.6/96.5   ] }   ,
		  ...
		  'a' : { '1': { 'abs':  [96.5 , 10.76 , 1.087 ] , 'rel': [1 , 10.76/96.5  , 1.087/96.5 ] }   , # ok
	          ...
	          'h' : { '1': { 'abs':  [96.5 , 0.18 , 0.0007 ] , 'rel': [1 , 0.18/96.5  , 0.0007/96.5   ] }   ,
	                  '3': { 'abs':  [18.63 , 0.05, 0.0005]   , 'rel': [1 , 0.05/18.63 , 0.0005/18.63  ] }   ,
	                 '10': { 'abs':  [3.06, 0.012,   0.0079]  , 'rel': [1 , 0.012/3.06  , 0.0079/3.06  ] } } , 

		  'x' : { '1': { 'abs':  [96.5 , 23.34 , 99999 ]  , 'rel': [1 , 23.34/96.5  , 0.6/96.5   ] }  ,
	                  '3': { 'abs':  [18.63 , 9.50, 99999]     , 'rel': [1 , 9.50/18.63 , 0.73/18.63 ] }  ,
	                  '10': { 'abs': [3.06, 2.81,   99999]      , 'rel': [1 , 2.81/3.06  , 0.411/3.06  ] } } , 

		  'all' : { '1': { 'abs':  [96.5 , 119.8 , 99999 ]  , 'rel': [1 , 	1  , 0.6/96.5   ] }  ,
	                    '3': { 'abs':  [18.63 , 28.15, 99999]     , 'rel': [1 , 1 , 0.73/18.63 ] }  ,
	                    '10': { 'abs': [3.06, 5.85,   99999]      , 'rel': [1 , 1  , 0.411/3.06  ] } } , 
