...
Relevant parameters in the param\_card and run\_card:

\begin{verbatim}
*** run_card
1001.0     = ebeam1  for $m_{\chi_D}$=1 TeV
...
$m_{\chi_D} $ & $\chi _D \chi _D \rightarrow WW $ & $\chi _D \chi _D \rightarrow WW X $ & $\chi _D \chi _D \rightarrow WWX X $ & $\chi _D \chi _D \rightarrow WW X X X$   \\
  ...
  \end{tabular}
  \caption{The "New" cross sections were computed with $N_{Events}$=10,000, while the "Old" ones with $N_{Events}$=100,000.  }
  \label{xsec}
\end{table*}
